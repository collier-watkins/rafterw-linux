...
in
{
  ...
  home.sessionVariables = {
    ...
    XCURSOR_SIZE = "24";
    XDG_CURRENT_DESKTOP = "sway"; # Changed to reflect Sway
    XDG_THEME = "dark";
  };

  # Disable xsession for Wayland-only setup
  ...
  wayland.windowManager.sway = {
    ...
    config = {
      startup = [
        ...
        #{ command = "$HOME/.config/sway/set-cursor.sh"; } # Add cursor script
      ];
      bars = [
    ...
    extraConfig = ''
      # Set cursor theme and size for all seats
      seat * xcursor_theme Material-Cursors 24
      seat * xcursor_theme Adwaita 24
    '';
  };

  # Cursor startup script
  #home.file.".config/sway/set-cursor.sh" = {
  #  text = ''
  #    #!/usr/bin/env bash
  #    swaymsg seat seat0 xcursor_theme Material-Cursors 64
  #    swaymsg seat seat0 xcursor_theme Adwaita 64
  #  '';
  #  executable = true;
  #};

  # Rest of your config (waybar, backgrounds, etc.) remains unchanged
  programs.waybar = {
    enable = true;
    settings = {
      mainBar = {
